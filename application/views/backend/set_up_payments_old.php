 ...
 <div id="page-wrapper">
    ...
    <div class="col-md-12">
      ...
      <ul class="nav nav-tabs responsive-tabs">
                ...
                <li role="presentation"><a href="#flo2Cash"  role="tab" data-toggle="tab">CC</a></li>            		<li role="presentation" class="active"><a href="#dyanamic"  role="tab" data-toggle="tab">Dynamic</a></li>                <li role="presentation"><a href="#poli" role="tab" data-toggle="tab">POLi</a></li>

      </ul>

	  <div class="tab-content">
              <div role="tabpanel" class="tab-pane  active" id="dyanamic">
                  <div class="row">                    <form role="form" method="post" action="<?php echo base_url(); ?>index.php/backend/payment/dynamic_payment_method" id="dynamic_form" enctype="multipart/form-data">
                      <div class="row">
                 ...
                 <div class="col-lg-8 col-md-10">
                   ...
                   <div class="row">
                     <div class="col-lg-4 col-md-5">
                       <input type="radio" id="cc_dps" name="pay_type" value="1"><label class="chkbox_space" for="cc_dps">DPS</label>
                     </div>
                   </div>
                   <div class="row">
                   ...
                   <div class="row">
                     <div class="col-lg-4 col-md-5">
                       <input type="radio" name="pay_type" id="cc_flo2cash" value="2" checked><label class="chkbox_space" for="cc_flo2cash">Flo2Cash</label>
                     </div>
                   </div>
                   <div class="row">
               ...
               <div class="row buttons">
                 ...
                 <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
				  ...
				  <form role="form" method="post" action="" id="dps_form" enctype="multipart/form-data">
                  <div class="row">
          <div class="col-lg-8 col-md-10">
                <div class="row">
