	...
	<div class="container-fluid">
			...
			<div class="col-md-12">
				...
				<div class="right_first_box">
					...
					<img src="<?php echo $this->config->item('admin_image_path');?>home.png">
						...
						<a href="#">Home</a> > <a href="#">Add Video CMS</a>
		...
		<div class="row margin_top margin_bottom">
			...
			<div class="col-md-12">
				...
				<div class="blue_top">Add Video CMS</div>
				...
				<div class="table-responsive table_white_box" style="padding:25px;">
					...
					<form method="post" action="<?php echo base_url(); ?>index.php/backend/manage_videos/save" id="my_profile" name="my_profile">



					<input type="hidden" name="cms_update" value=""/>
					...
					<div class="col-lg-10 col-md-11">
						...
						<div class="row">
							...
							<div class="col-md-6"> <input type="text" class="inp" id="category" name="category" value="" placeholder="category">
						...
						<div class="row">
							 ...
							 <div class="col-md-9" style="z-index:9999"><textarea name="content" class="inp" id="editor1" rows="20" cols="80" class="inp"></textarea>
