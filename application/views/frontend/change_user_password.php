...
<div class="row margin_top margin_bottom">
            ...
            <div >
					<form method="post" action="<?php echo $this->config->item('user_save_change_password');?>" id="change_password" name="change_password">
		...
		user_validation.UTIL =
		{
			setupFormValidation: function()
			{
				...
				$("#change_password").validate({
					...
					messages: {
						confirm_password: {  
							equalTo: jQuery.validator.format("Confirm password should be same as New Password")
						},
					},
