...
<meta property="og:description" content="<?php echo $data['message'];?>" />
...
<style>
	...
	.adjust_donation_box_margin{margin-top:5px;}
	.gray_bg_radio{padding:10px;height:48px;}
	
	.message_error .error{margin-left: 60px;}
                        ...
                        <div class="col-md-4 col-sm-4">
							<div class="row adjust_donation_box_margin">
								...
								<div class="col-md-9 col-sm-9">								
									<input type="text" id="target_amount" name="target_amount" value="<?php echo set_value('target_amount',$user_data['donation_amount']); ?>"class="form-control required" placeholder="Amount in $" maxlength="4">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 message_error">                        	
							<textarea style="width:475px;margin-left:60px;" rows="5" cols="20" id="donor_mssg" name="donor_mssg" class="form-control search_events" placeholder=""><?php echo $user_data['donar_message'];?></textarea>
					...
					<div class="col-md-2 col-sm-2">
						<input type="radio" id="chkYes" name="org_name" value="organisation" <?php echo  set_radio('org_name', 'organisation'); ?> class="search_events" onclick="ShowHideDiv();">&nbsp;&nbsp;&nbsp;<label for="">Organization</label>						
					</div>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<select class="search_events form-control dropdown" id="select_salutation" name="select_salutation" >
								<option value="Mr" <?php echo set_select('select_salutation', 'Mr', TRUE); ?>>Mr</option>
...
<input type="text" id="first_name" name="first_name" value="<?php echo set_value('first_name',$user_data['first_name']);?>" class="form-control search_events" placeholder="Name">
				...
				<div class="col-md-8">
					<div class="row">
						<div class="col-md-4">
							<label for="post_code" class="search_events">Postal Code</label>
						</div>
						<div class="col-md-8">
							<input type="text" id="postal_code" name="postal_code" value="<?php echo set_value('postal_code'); ?>" class="form-control search_events" placeholder="Postal Code">
						</div>
					</div>
				</div>
				...
				<div class="col-md-8">
					<div class="row">
						<div class="col-md-4">
							<label for="" class="search_events">Country<span>*</span></label>
						</div>
						<div class="col-md-8">
							<select class="search_events form-control dropdown" id="country" name="country" > 				
								<option selected value="New Zealand" <?php echo set_select('country', 'New Zealand', TRUE);?> >New Zealand</option>
			...
			<!--	<div class="col-md-12">
				...
				<div class="col-md-1" style="margin-right:40px;">
					<a href="#"><button class="search_events add_more_btn">Submit</button></a>
				</div>
				<div class="col-md-1">
					<a href="#" onclick="window.history.back();"><button type="button" class="search_events add_more_btn">Cancel</button></a>
				</div>
				<?php } ?>
				</form>
          </div><!--Container-->
