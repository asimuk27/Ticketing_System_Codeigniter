   ...
   <input type="hidden" name="organiser_id" value="<?php echo $org_id; ?>">
    ...
    <div class="col-md-6">
        ...
        <div class="search_events input-group">
            ...
            <input type="text" id="logo_name" name="logo_name" class="search_events" placeholder="" value="<?php echo $data['logo']; ?>" readonly>
    ...
    <div class="col-md-6" style="margin-bottom:10px;">
     ...
     <label id="logo_error"></label>
		<?php if($data["logo"]){?>
			<img id="blah" src="<?php echo $this->config->item("organisation_logo")."/".$data["logo"]; ?>" alt="" style="display:block;height:inherit;width:inherit;"/>
		<?php }else{ ?>
			<img id="blah" src="<?php echo $this->config->item("organisation_logo")."/".$data["logo"]; ?>" alt="" style="display:none;height:inherit;width:inherit;"/>
...
<div class="col-md-6">
    ...
    <div class="search_events input-group">
        ...
        <input type="text" id="ste" name="ste" placeholder="" value="" readonly>
...
<div class="col-md-6 col-sm-6 col-xs-12">
 ...
 <?php if($data['bank_statement_ticket_suite']!=0){echo "<a style='color:blue; target='_blank' href='https://local.ticketing_system.com/assets/image_uploads/bank_statement/".$data['bank_statement']."'>".$data['bank_statement'].'</a>'; } ?>
...
<div class="col-md-6">
   ...
   <input type="checkbox" name="bank_details_for_ticket_suit" id="bank_details_for_ticket_suit" value="0">&nbsp;&nbsp;&nbsp;<label for="bank_details_for_ticket_suit">Same as above</label>
...
<div  id="ticket_suit_bank_details">
    ...
    <div class="col-md-6">
        ...
        <div class="search_events input-group">
            ...
            <input type="text" id="ste2" name="ste2" placeholder="" value="" readonly>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <p id="true_ts" style="display:none; color:green">Successfully attached</p>
		 <?php if($data['bank_statement_ticket_suite']!=0){echo "<a style='color:blue;' target='_blank' href='https://local.ticketing_system.com/assets/image_uploads/bank_statement/".$data['bank_statement_ticket_suite']."'>".$data['bank_statement_ticket_suite'].'</a>'; } ?>
...
<div class="col-md-6" style="margin-bottom:10px;">
	...
	<?php }else{ ?>
	<img id="bank_signature_preview" src="<?php echo $this->config->item("organisation_signature")."/".$data["signature"]; ?>" alt="" style="display:none;" height="200px;"/>
...
<br class="clear">
    <div class="col-md-6">
        ...
        <select class="search_events form-control dropdown" id="plan_select" name="plan_select">
            <option value="">-- Please Select --</option>
            <option value="1" <?php if($data['plan_select'] == "1"){ echo "selected";}else{ echo "";}?>>Standard Suite Plan $29 per month</option>
            <option value="2" <?php if($data['plan_select'] == "2"){ echo "selected";}else{ echo "";}?>>Deluxe Suite Plan $59 per month plus fees (4% of the transaction’s value)</option>
        </select>
    </div>
<br class="clear">
...
<div class="col-md-6">
   ...
   <input type="checkbox" name='tc' id="eve_tc" onclick="return false"  <?php if($t_n_c['tc_status']==1){echo "value=1 checked=true";}else{echo "value=0";} ?>>&nbsp;&nbsp;&nbsp;<a for="tc" class="search_events common_check" data-toggle="modal" data-target="#myModal" style="cursor:pointer">Event Manager and TicketingSystem Terms and Conditions</a>
...
<div class="col-md-6">
   ...
   <input type="checkbox" name='poli_tc' id="poli_tc"   <?php if($t_n_c['poli_status']==1){echo "value=1 checked=true";}else{echo "value=0";} ?> onclick="return false" >&nbsp;&nbsp;&nbsp;<a for="tc" class="search_events common_check" data-toggle="modal" data-target="#myModal" style="cursor:pointer"  >POLi  Terms & Conditions</a>
...
<div class="col-md-6">
   ...
   <input type="checkbox" name='direct_debit_tc' id="direct_debit_tc" <?php if($t_n_c['direct_debit_status']==1){echo "value=1 checked=true";}else{echo "value=0";} ?>  onclick="return false" >&nbsp;&nbsp;&nbsp;<a for="tc" class="search_events common_check" data-toggle="modal" data-target="#myModal" style="cursor:pointer">TicketingSystem Direct Debit Authority</a>
...
<br class="clear">
	<div class="col-md-6 font_special">
		<p>
			Clicking the Save button stores the changes you have made in the application form. Once you have completed the application form the application will automatically be placed in a que for approval by TicketingSystem.
		</p>
	</div>
<br class="clear">
