	...
	<div class="content">
		...
		<div class="kode-blog-style-2">
	  	  <div class="container">
				...
				?>
                <div class="search_events table-responsive table_white_box">
				...
				<a href="<?php echo $this->config->item('add_champion_page'); ?>?event_id=<?php echo urlencode($event_info['0']['id']);?>&sub_event_id=<?php echo urlencode($sub_event_data[0]['id']); ?>"><button class="three_inline_buttons center-tags">Be a Champion</button></a>
							...
							<div class="col-md-10 include_padding">
                ...
                <?php }
                }else{ ?><table class="table table-hover" id="ticket_booking">
                  <thead>
                     <tr class="text-center">
                    <th style="width:20%;">Title</th>
                    <th style="width:10%">Time</th>
                    <th style="width:20%;">Event Ticket Type</th>
                    <th style="width:10%">Price</th>
                    <?php  if($event_info[0]['show_remaining_tickets']==1){ ?>
						<th style="width:10%">Ticket Sold</th>
                    <?php } ?>
                    <th>Action</th>
                    <th></th>
                     </tr>
             ...
             <a class="three_inline_buttons center-tags" href="<?php echo $this->config->item('add_champion_page'); ?>?event_id=<?php echo urlencode($event_info['0']['id']);?>&sub_event_id=<?php echo urlencode($individual_sub_event['sub_event_id']); ?>">Be a Champion</a>
                ...
                ?>
                    <tr class="circular_row_box">
                        <td style="width:20%;"><?php echo $individual_sub_event['schedule_title'];?></td>
                        <td style="width:10%;">
                    <?php echo $individual_sub_event['schedule_start_time'];?></td>
                     <td style="width:20%;"><?php echo $individual_sub_event['ticket_name'];?></td>
                     <td style="width:10%;">
                      <?php
                    ...
                    <td style="width:10%">
                      ...
                      <?php if($individual_sub_event['out_of_stock'] == 0){ ?>
