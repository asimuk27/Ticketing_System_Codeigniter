...
<table style="width:100%;">
	<tr style="background:#fff;">
		...
		Your order number #<?php echo $even_sub_events['order_id'];?> for <?php echo $event_details['title'];?> Organized by <?php echo $organizer_data->charity_name;?> has been confirmed<br><br>
Cheers! <br><br>
...
<tr>
<td>
 <!--<div style="width:100%;height:120px;"><img src="<?php echo $this->config->item('email_template_image_path')."/paper.png";?>" style="height:118px;;margin:0 auto;display:block;clear:both;"></div>-->
...
<td style="width:50%;text-align:right;"><?php echo $order_info['txn_date'];?></td>
</tr>
</table>
...
<td style="width:20%;text-align:right;">Quantity</td>
</tr>
</table>
...
<?php foreach($ticket_data as $tickets){ ?>
	<table style="width:100%;font-size:14px;color:#666666;">
	<tr style="width:100%;">
	<td style="width:30%;"><?php echo $tickets['ticket_id'];?></td>
	<td style="width:60%;"><?php echo $tickets['ticket_name'];?></td>
	<td style="width:20%;text-align:right;"><?php echo $tickets['quantity'];?></td>
	</tr>
	</table>
<?php } ?>
<br>
<div style="color:#666666;">This order is subject to TicketingSystem <a href="#" class="blue_anker">Terms of Service</a>, <a href="#" class="blue_anker">Privacy Policy</a></div>
</div>
