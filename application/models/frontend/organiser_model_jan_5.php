...
class Organiser_model extends CI_Model
{
	...
	public function save_poli_terms_n_conditions($data_save_poli_tc){
		
		$result = $this->db->insert("organizer_terms_conditions", $data_save_poli_tc);
		$insert_id = $this->db->insert_id();
		return  $insert_id;
		
	}
	
	public function save_debit_terms_n_conditions($data_save_direct_debit_tc){
		
		$result = $this->db->insert("organizer_terms_conditions", $data_save_direct_debit_tc);
		$insert_id = $this->db->insert_id();
		return  $insert_id;
